...
<div class="main-content">
    ...
    <?php
        ...
        if(isset($_POST['submit']))
        {
            ...
            //2 is to insert data into database
            if(isset($_FILES['image']['name']))
            {
                //get the details of selected image
                $image_name=$_FILES['image']['name'];
                //check whether the image is selected or not and uplod image only if selected
                if($image_name!=""){
                    //image is selected
                    //A rename the image
                    ...
                    //create new name for image name
